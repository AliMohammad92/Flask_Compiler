// Generated from C:/Users/Ali/IdeaProjects/Flask_Compiler/src/ANTLR/PythonLexer.g4 by ANTLR 4.13.2
package gen.ANTLR;
...
public class PythonLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"IN", "IS", "AS", "SET", "PIPE", "TYPE", "INCLUDE", "EXTENDS", "ENDIF", 
			...
			"COLON", "SEMI", "COMMA", "DOT", "HASHTAG", "AT", "CSS_COM_S", "CSS_COM_E", 
			"HTML", "HEAD", "BODY", "TITLE", "META", "LINK", "STYLE", "SCRIPT", "DIV", 
			"SPAN", "P", "A", "IMG", "SRC", "HREF", "ALT", "LANG", "H1", "H2", "H3", 
			"H4", "H5", "H6", "UL", "OL", "LI", "TABLE", "TR", "TD", "TH", "INPUT", 
			"FORM", "BUTTON", "LABEL", "SELECT", "OPTION", "TEXTAREA", "ID", "NAME", 
			"VALUE", "CONTENT", "REL", "BR", "HR", "NUMBER", "STRING", "HTMLTEXT", 
